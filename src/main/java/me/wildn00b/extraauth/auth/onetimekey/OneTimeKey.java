...
package me.wildn00b.extraauth.auth.onetimekey;
...
public class OneTimeKey extends AuthMethod {
  ...
  public FailedReason Authenticate(PlayerInformation information,
    ...
    if (args.length > 0) {
      ...
      for (int i = 1; i < args.length; i++)
        key += " " + (String) args[1];
      if (information.getPrivateKey().equals(key)) {
        information.setAuthed(true);
        ExtraAuth.INSTANCE.DB.Remove(information.getPlayer());
  ...
  public String GetHelpLine(String language) {
    return ExtraAuth.INSTANCE.Lang._("Command.Enable.OneTimeKey.Help");
  }
  ...
  public String GetOtherHelpLine(String language) {
    return ExtraAuth.INSTANCE.Lang._("Command.Enable.OneTimeKey.Other.Help");
  }
