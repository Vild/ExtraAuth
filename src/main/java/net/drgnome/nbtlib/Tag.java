...
public final class Tag<T> {
   ...
   *           If the Map contains a value that can't be represented by a {@link Tag} object.
   */
   ...
   * 
   * @throws UnknownTagException
   *           If the List contains an element that can't be represented by a {@link Tag} object.
   */
  public static Tag<List<Tag>> newList(List data)
    ...
    List<Tag> list;
    try {
      for (final Object o : data.toArray())
        Tag.class.cast(o);
      list = data;
    } catch (final ClassCastException e) {
